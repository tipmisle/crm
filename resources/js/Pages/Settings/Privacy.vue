...
function cancelDeletion() {
    if (!confirm('Prekliči izbris delovnega prostora?')) return;
        ...
        <div class="mx-auto max-w-2xl space-y-4 px-4 py-6 sm:px-6">
            <SectionCard title="Izvozi podatke" subtitle="Prenesi vse podatke svojega delovnega prostora">
                <p class="mb-4 text-sm text-neutral-600">
                    Izvoz vsebuje stranke, pogovore, sporočila, naročila, termine in ponudbo tvojega delovnega prostora
                    v strojno berljivi obliki. Izvoz je na voljo za prenos {{ exportHours }} ur, nato ga samodejno izbrišemo.
                </p>
            ...
            <SectionCard v-if="isOwner" title="Izbriši delovni prostor">
                ...
                <div v-else>
                    <p class="mb-4 text-sm text-neutral-600">
                        Izbris trajno odstrani stranke, pogovore, naročila, termine in vse ostale podatke tega delovnega
                        prostora. Podatkov po poteku obdobja za obnovitev ni več mogoče povrniti.
                    </p>
                    <p v-if="hasActiveSubscription" class="mb-4 text-sm text-amber-700">
                        Ta delovni prostor ima aktivno naročnino — izbris jo bo ob dokončnem izbrisu podatkov tudi
                        preklical.
                    </p>
                    <button
                        type="button"
