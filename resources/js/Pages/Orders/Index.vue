...
import { Search, Plus, LayoutGrid, List } from 'lucide-vue-next';
...
<template>
    ...
    <AppLayout>
        ...
        <div class="mx-auto max-w-5xl space-y-5 px-6 py-8">
            ...
            <EmptyState v-else title="No orders found" description="Try adjusting your filters, or create a new order.">
