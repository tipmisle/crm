...
const faqs = [
    {
        q: 'Katere kanale lahko povežem z Beležko?',
        a: 'Trenutno lahko povežeš Instagram in Facebook Messenger. Podpora za TikTok in WhatsApp je v pripravi.',
    },
    {
        q: 'Ali lahko na sporočila odgovarjam kar iz Beležke?',
        a: 'Da. Sporočila iz povezanega Instagrama in Facebook Messengerja prejemaš v Beležki in nanje odgovoriš neposredno tam, brez preklapljanja med aplikacijami.',
    },
    {
        q: 'Ali moram uporabljati naročila in termine?',
        a: 'Ne. Uporabljaš lahko samo naročila, samo termine ali oboje — glede na to, kako dela tvoj posel.',
    },
    {
        q: 'Ali Beležka sama ustvari naročilo ali termin iz sporočila?',
        a: 'Ne. Ti odločiš, kdaj pogovor postane naročilo ali termin. Iz pogovora ga ustvariš v nekaj klikih, podatki pa ostanejo povezani s stranko in pogovorom.',
    },
    {
        q: 'Kaj potrebujem za povezavo Instagrama?',
        a: 'Tvoj Instagram račun mora biti profesionalni (Business ali Creator) in povezan s Facebook stranjo. To je zahteva Meta platforme, ne Beležke.',
    },
    {
...
<template>
    ...
    <MarketingLayout>
        ...
        <section id="kako-deluje" class="border-t border-neutral-100 bg-white py-20 sm:py-28">
            <div class="mx-auto max-w-6xl px-4 sm:px-6">
                <span id="za-koga" aria-hidden="true" />
                <Reveal>
                    <h2 class="text-center text-3xl font-semibold tracking-tight text-neutral-900 sm:text-4xl">
                ...
                <Reveal :delay="60">
                    <p class="mx-auto mt-4 max-w-lg text-center text-[15px] text-neutral-500">
                        Ne glede na to, ali sprejemaš naročila, rezerviraš termine ali oboje — Beležka se prilagodi
                        tvojemu načinu dela.
                    </p>
                </Reveal>

                <div class="mt-12 grid grid-cols-1 overflow-hidden rounded-2xl border border-neutral-200 lg:grid-cols-2">
                    <!-- Naročila -->
                    <Reveal>
                        <div class="h-full bg-white p-8 sm:p-10">
                            <p class="text-xs font-semibold tracking-wide text-[var(--color-accent-600)] uppercase">Naročila</p>
                            <h3 class="mt-1.5 text-xl font-semibold text-neutral-900">Sprejemaš naročila?</h3>
                            <p class="mt-2.5 max-w-sm text-sm text-neutral-600">
                                Iz pogovora ustvari naročilo, določi rok, ceno in plačilo ter spremljaj status vse do
                                zaključka.
                            </p>

                            <div class="mt-6 max-w-xs rounded-xl border border-neutral-200 bg-white p-4 shadow-sm shadow-neutral-900/[0.04]">
                                <div class="flex items-center gap-1.5 text-[10px] font-medium text-neutral-400 uppercase">
                                    <ChannelIcon type="instagram" size="sm" /> Instagram
                                </div>
                                <p class="mt-2 text-sm font-semibold text-neutral-900">Rojstnodnevna torta</p>
                                <p class="text-xs text-neutral-500">Nina Kovač</p>
                                <div class="mt-3 space-y-1.5 border-t border-neutral-100 pt-3 text-xs">
                                    <div class="flex items-center justify-between">
                                        <span class="text-neutral-400">Rok</span>
                                        <span class="font-medium text-neutral-800">30. avgust</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-neutral-400">Cena</span>
                                        <span class="font-medium text-neutral-800">85 €</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-neutral-400">Plačilo</span>
                                        <Badge :color="depositPaid.color" :bg="depositPaid.bg">Ara plačana</Badge>
                                    </div>
                                </div>
                                <div class="mt-3 flex flex-wrap items-center gap-1.5 border-t border-neutral-100 pt-3">
                                    <Badge class="opacity-50" color="#4B5563" bg="#F1F2F4">Novo</Badge>
                                    <Badge class="opacity-50" color="#0E7490" bg="#E0F7FA">Potrjeno</Badge>
                                    <Badge color="#6A3CCB" bg="#EBE5FD">V pripravi</Badge>
                                    <Badge class="opacity-50" color="#0F766E" bg="#DBF6EF">Pripravljeno</Badge>
                                </div>
                            </div>

                            <p class="mt-6 text-sm text-neutral-500">
                                Torte, cvetje, darila po meri, ročno izdelani in digitalni izdelki.
                            </p>
                        </div>
                    </Reveal>
                    ...
                    <Reveal :delay="100">
                        <div class="h-full border-t border-neutral-200 bg-neutral-50 p-8 sm:border-t-0 sm:border-l sm:p-10">
                            <p class="text-xs font-semibold tracking-wide text-[var(--color-accent-600)] uppercase">Termini</p>
                            <h3 class="mt-1.5 text-xl font-semibold text-neutral-900">Sprejemaš rezervacije?</h3>
                            <p class="mt-2.5 max-w-sm text-sm text-neutral-600">
                                Iz pogovora rezerviraj termin, izberi storitev in trajanje ter spremljaj ceno,
                                plačilo in status.
                            </p>

                            <div class="mt-6 max-w-xs rounded-xl border border-neutral-200 bg-white p-4 shadow-sm shadow-neutral-900/[0.04]">
                                <p class="text-sm font-semibold text-neutral-900">Korekcija BIAB</p>
                                <p class="text-xs text-neutral-500">Maja Kovač</p>
                                <div class="mt-3 space-y-1.5 border-t border-neutral-100 pt-3 text-xs">
                                    <div class="flex items-center justify-between">
                                        <span class="text-neutral-400">Termin</span>
                                        <span class="font-medium text-neutral-800">Petek, 14:00–15:15</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-neutral-400">Trajanje</span>
                                        <span class="font-medium text-neutral-800">75 min</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-neutral-400">Cena</span>
                                        <span class="font-medium text-neutral-800">42 €</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-neutral-400">Plačilo</span>
                                        <Badge :color="depositPaid.color" :bg="depositPaid.bg">Ara plačana</Badge>
                                ...
                                <div class="mt-3 border-t border-neutral-100 pt-3">
                                    <Badge color="#0E7490" bg="#E0F7FA">Potrjeno</Badge>
                                </div>
                            </div>

                            <p class="mt-6 text-sm text-neutral-500">
                                Nohti, frizerstvo, trepalnice in obrvi, tetoviranje, fotografija in lepotne storitve.
                            </p>
                        </div>
                    </Reveal>
                </div>
            ...
            <div class="mx-auto max-w-2xl px-4 text-center sm:px-6">
                <Reveal>
                    <h2 class="text-2xl font-semibold tracking-tight text-neutral-900 sm:text-3xl">
                        Poveži kanale, kjer ti stranke že pišejo.
                    </h2>
                </Reveal>
                ...
                <Reveal>
                    <div>
                        <h2 class="text-3xl font-semibold tracking-tight text-white sm:text-4xl">
                            Odpreš Beležko.<br />Takoj veš, kaj te čaka danes.
                        </h2>
                        <p class="mt-5 max-w-md text-neutral-300">
                            Ne iščeš več po pogovorih, koledarju in zapiskih. Na enem mestu vidiš sporočila, termine,
                            naročila in stvari, ki jih moraš urediti danes.
                        </p>
                    </div>
                </Reveal>

                <Reveal :delay="150">
                    <div class="overflow-hidden rounded-2xl border border-white/10 bg-white shadow-2xl shadow-black/30">
                        <div class="bg-gradient-to-br from-[var(--color-accent-500)] to-[var(--color-accent-700)] px-5 py-4 text-white">
                            <p class="text-sm font-semibold">Danes, 15. avgust</p>
                            <p class="mt-1 text-xs text-white/80">3 neodgovorjena sporočila · 2 termina · 1 naročilo z rokom danes</p>
                        </div>

                        <div class="space-y-4 p-4">
                            <!-- Unanswered messages: needs attention -->
                            <Reveal :delay="0">
                                <div>
                                    <p class="px-0.5 text-[10px] font-semibold tracking-wide text-neutral-400 uppercase">Neodgovorjena sporočila</p>
                                    <div class="mt-2 flex items-start gap-2.5 rounded-lg border border-[var(--color-accent-200)] bg-[var(--color-accent-50)] px-3 py-2.5">
                                        <span class="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[var(--color-accent-500)]" />
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center justify-between gap-2">
                                                <p class="text-sm font-semibold text-neutral-900">Nina Kovač</p>
                                                <span class="shrink-0 text-[10px] text-neutral-400">pred 18 min</span>
                                            </div>
                                            <div class="flex items-center gap-1 text-[10px] text-neutral-400">
                                                <ChannelIcon type="instagram" size="sm" /> Instagram
                                            </div>
                                            <p class="mt-1 text-xs text-neutral-700">"Super, hvala! Kdaj lahko prevzamem?"</p>
                                            <button type="button" class="mt-1.5 text-xs font-semibold text-[var(--color-accent-600)]">
                                                Odpri pogovor →
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <Reveal :delay="80">
                                <div>
                                    <p class="px-0.5 text-[10px] font-semibold tracking-wide text-neutral-400 uppercase">Današnji termini</p>
                                    <div class="mt-2 space-y-1.5">
                                        <div class="flex items-center justify-between rounded-lg border border-neutral-100 px-3 py-2">
                                            <div class="flex items-center gap-2.5">
                                                <span class="text-xs font-semibold text-neutral-900">09:00</span>
                                                <span class="text-xs text-neutral-600">Ana Novak · Gel nohti</span>
                                            </div>
                                            <span class="text-[10px] text-neutral-400">60 min</span>
                                        </div>
                                        <div class="flex items-center justify-between rounded-lg border border-neutral-100 px-3 py-2">
                                            <div class="flex items-center gap-2.5">
                                                <span class="text-xs font-semibold text-neutral-900">14:30</span>
                                                <span class="text-xs text-neutral-600">Maja Kovač · Korekcija BIAB</span>
                                            </div>
                                            <span class="text-[10px] text-neutral-400">75 min</span>
                                        </div>
                                    </div>
                                </div>
                            </Reveal>

                            <!-- Order due today: strongest urgency -->
                            <Reveal :delay="160">
                                <div>
                                    <p class="px-0.5 text-[10px] font-semibold tracking-wide text-neutral-400 uppercase">Naročila za danes</p>
                                    <div class="mt-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2.5">
                                        <div class="flex items-center justify-between gap-2">
                                            <p class="text-sm font-semibold text-neutral-900">Rojstnodnevna torta</p>
                                            <Badge color="#6A3CCB" bg="#EBE5FD">V pripravi</Badge>
                                        </div>
                                        <p class="mt-0.5 text-xs text-neutral-600">Nina Kovač · Prevzem ob 16:00</p>
                                        <button type="button" class="mt-1.5 text-xs font-semibold text-amber-700">
                                            Označi kot pripravljeno →
                                        </button>
                                    </div>
                                </div>
                            </Reveal>
                            ...
                            <Reveal :delay="240">
                                <div class="flex items-center gap-2 rounded-lg border border-neutral-100 px-3 py-2.5">
                                    ...
                                    <span class="text-xs text-neutral-500">16:30 — Piši Tini glede ponudbe</span>
                                </div>
                            </Reveal>
                        </div>
                    </div>
            ...
            <div class="mx-auto max-w-6xl px-4 sm:px-6">
                <Reveal>
                    <h2 class="mx-auto max-w-xl text-center text-3xl font-semibold tracking-tight text-neutral-900 sm:text-4xl">
                        Manj ročnega dela. Več pregleda.
                    </h2>
                </Reveal>

                <Reveal :delay="60">
                    <p class="mx-auto mt-4 max-w-lg text-center text-[15px] text-neutral-500">
                        Cene in storitve vneseš enkrat, Beležka te spomni na pomembne stvari in sproti pokaže, kaj se
                        v tvojem poslu dejansko dogaja.
                    </p>
                </Reveal>

                <div class="mt-14 space-y-6">
                    <!-- Katalog: full-width workflow composition -->
                    <Reveal>
                        <div class="rounded-2xl border border-neutral-200 bg-neutral-50 p-6 sm:p-10">
                            <div class="grid grid-cols-1 items-center gap-8 lg:grid-cols-[minmax(0,1fr)_auto]">
                                <div>
                                    ...
                                    <h3 class="mt-2 text-2xl font-semibold text-neutral-900">Vpišeš enkrat. Uporabljaš znova in znova.</h3>
                                    <p class="mt-3 max-w-md text-neutral-600">
                                        Shrani svoje izdelke in storitve s ceno, trajanjem in aro. Ko ustvariš novo
                                        naročilo ali termin, samo izbereš pravo možnost in podatki se izpolnijo sami.
                                    </p>
                                </div>

                                <div class="flex flex-col items-center gap-3 sm:flex-row">
                                    <Reveal :delay="80">
                                        <div class="w-full rounded-xl border border-neutral-200 bg-white p-4 shadow-sm shadow-neutral-900/[0.04] sm:w-48">
                                            <p class="text-[10px] font-semibold tracking-wide text-neutral-400 uppercase">Storitve</p>
                                            <div class="mt-2.5 space-y-2.5 text-xs">
                                                <div class="border-b border-neutral-100 pb-2">
                                                    <p class="font-medium text-neutral-800">Gel nohti</p>
                                                    <p class="text-neutral-500">60 min · 38 €</p>
                                                </div>
                                                <div class="-mx-1.5 rounded-md bg-[var(--color-accent-50)] px-1.5 py-1 pb-2">
                                                    <div class="flex items-center gap-1 font-medium text-[var(--color-accent-700)]">
                                                        <Check :size="11" /> Korekcija BIAB
                                                    </div>
                                                    <p class="text-neutral-500">75 min · 42 €</p>
                                                </div>
                                                <div>
                                                    <p class="font-medium text-neutral-800">Vihanje trepalnic</p>
                                                    <p class="text-neutral-500">60 min · 45 €</p>
                                                </div>
                                            </div>
                                        </div>
                                    </Reveal>

                                    <ArrowRight :size="16" class="hidden shrink-0 text-neutral-300 sm:block" />
                                    <div class="h-4 w-px bg-neutral-300 sm:hidden" />

                                    <Reveal :delay="160">
                                        <div class="w-full rounded-xl border border-[var(--color-accent-200)] bg-[var(--color-accent-50)] p-4 sm:w-48">
                                            <p class="text-[10px] font-semibold tracking-wide text-[var(--color-accent-600)] uppercase">Nov termin</p>
                                            <div class="mt-2.5 space-y-1.5 text-xs">
                                                <div class="flex items-center justify-between">
                                                    <span class="text-neutral-500">Storitev</span>
                                                    <span class="font-medium text-neutral-900">Korekcija BIAB</span>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <span class="text-neutral-500">Trajanje</span>
                                                    <span class="font-medium text-neutral-900">75 min</span>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <span class="text-neutral-500">Cena</span>
                                                    <span class="font-medium text-neutral-900">42 €</span>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <span class="text-neutral-500">Ara</span>
                                                    <span class="font-medium text-neutral-900">10 €</span>
                                                </div>
                                            </div>
                                        </div>
                                    </Reveal>
                    ...
                    <!-- Opomniki + Analitika: focused card + larger data card -->
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_1.3fr]">
                        <Reveal>
                            <div class="h-full rounded-2xl border border-neutral-200 bg-neutral-50 p-6 sm:p-8">
                                <p class="text-xs font-semibold tracking-wide text-[var(--color-accent-600)] uppercase">Opomniki</p>
                                <h3 class="mt-2 text-xl font-semibold text-neutral-900">Ni ti treba vsega držati v glavi.</h3>
                                <p class="mt-3 text-sm text-neutral-600">
                                    Nastavi opomnik neposredno pri stranki ali pogovoru in Beležka te pravočasno
                                    spomni, kaj moraš urediti.
                                </p>

                                <div class="mt-5 space-y-2">
                                    <div class="rounded-xl border border-[var(--color-accent-200)] bg-white p-3.5 shadow-sm shadow-neutral-900/[0.04]">
                                        <p class="text-[10px] font-semibold tracking-wide text-[var(--color-accent-600)] uppercase">Danes · 16:00</p>
                                        <p class="mt-1 text-sm text-neutral-800">Piši Maji glede ponudbe za poročno torto</p>
                                        <div class="mt-2 flex items-center justify-between">
                                            <div class="flex items-center gap-1.5 text-xs text-neutral-500">
                                                <ChannelIcon type="instagram" size="sm" /> Maja Kovač
                                            </div>
                                            <button type="button" class="text-xs font-semibold text-[var(--color-accent-600)]">Odpri pogovor →</button>
                                        </div>
                                    </div>
                                    <div class="rounded-xl border border-neutral-200 bg-white p-3.5">
                                        <p class="text-[10px] font-semibold tracking-wide text-neutral-400 uppercase">Jutri · 09:00</p>
                                        <p class="mt-1 text-sm text-neutral-600">Preveri plačilo are — Ana Novak</p>
                                    </div>
                                </div>
                            </div>
                        </Reveal>
                        ...
                        <Reveal :delay="100">
                            <div class="h-full rounded-2xl border border-neutral-200 bg-neutral-50 p-6 sm:p-8">
                                ...
                                <h3 class="mt-2 text-xl font-semibold text-neutral-900">Veš, od kod prihaja posel.</h3>
                                <p class="mt-3 max-w-md text-sm text-neutral-600">
                                    Spremljaj prihodke, od kod prihajajo povpraševanja ter kateri izdelki in storitve
                                    se najbolje prodajajo.
                                </p>

                                <div class="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div class="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm shadow-neutral-900/[0.04]">
                                        <p class="text-xs font-medium text-neutral-500">Ta mesec</p>
                                        <p class="mt-1 text-2xl font-semibold text-neutral-900">4.820 €</p>
                                        <p class="text-xs text-neutral-400">prihodka</p>
                                        <div class="mt-3 space-y-1.5 border-t border-neutral-100 pt-3 text-xs">
                                            <p class="font-medium text-neutral-400 uppercase">Po kanalih</p>
                                            <div class="flex items-center justify-between">
                                    ...
                                    <div class="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm shadow-neutral-900/[0.04]">
                                        <p class="text-xs font-medium text-neutral-500">Najbolj priljubljeno</p>
                                        <div class="mt-3 space-y-2.5 text-sm">
                                            <div class="flex items-center justify-between">
                                                <span class="text-neutral-700">Rojstnodnevne torte</span>
                                                <span class="font-semibold text-neutral-900">1.460 €</span>
                                            </div>
                                            <div class="flex items-center justify-between">
                                                <span class="text-neutral-700">Korekcija BIAB</span>
                                                <span class="font-semibold text-neutral-900">840 €</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section id="cena" class="border-t border-neutral-100 bg-neutral-50 py-20 sm:py-28">
            <div class="mx-auto max-w-4xl px-4 text-center sm:px-6">
                <Reveal>
                    <h2 class="text-3xl font-semibold tracking-tight text-neutral-900 sm:text-4xl">En paket. Brez kompliciranja.</h2>
                    <p class="mt-4 text-neutral-600">Vse ključne funkcije Beležke v enem paketu.</p>
                </Reveal>

                <Reveal :delay="100">
                    <div class="mx-auto mt-10 rounded-2xl border border-[var(--color-accent-200)] bg-white text-left shadow-lg shadow-[var(--color-accent-500)]/10 ring-1 ring-[var(--color-accent-500)]/5">
                        <div class="grid grid-cols-1 lg:grid-cols-[280px_1fr]">
                            <!-- price + CTA -->
                            <div class="p-8 sm:p-9 lg:border-r lg:border-neutral-100">
                                <span class="inline-flex items-center rounded-full bg-[var(--color-accent-50)] px-2.5 py-1 text-[11px] font-semibold tracking-wide text-[var(--color-accent-700)] uppercase">
                                    Vse vključeno
                                </span>
                                ...
                                <Link
                                    :href="route('register')"
                                    class="mt-6 flex w-full items-center justify-center gap-2 rounded-md bg-[var(--color-accent-500)] px-6 py-3 text-sm font-semibold text-white shadow-sm shadow-[var(--color-accent-500)]/25 transition hover:bg-[var(--color-accent-600)]"
                                >
                                    Začni z Beležko
                                    <ArrowRight :size="16" />
                                </Link>
                            ...
                            <!-- feature checklist -->
                            <div class="border-t border-neutral-100 p-8 sm:p-9 lg:border-t-0">
                                <p class="text-xs font-semibold tracking-wide text-neutral-400 uppercase">Kaj je vključeno</p>
                                <ul class="mt-4 grid grid-cols-1 gap-x-8 gap-y-3 text-sm text-neutral-700 sm:grid-cols-2">
                                    <li class="flex items-start gap-2">
                                        <Check :size="15" class="mt-0.5 shrink-0 text-[var(--color-accent-500)]" />
                                        Instagram in Facebook Messenger na enem mestu
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <Check :size="15" class="mt-0.5 shrink-0 text-[var(--color-accent-500)]" />
                                        Stranke in celotna zgodovina pogovorov
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <Check :size="15" class="mt-0.5 shrink-0 text-[var(--color-accent-500)]" />
                                        Naročila in rezervacije terminov
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <Check :size="15" class="mt-0.5 shrink-0 text-[var(--color-accent-500)]" />
                                    ...
                                    <li class="flex items-start gap-2">
                                        <Check :size="15" class="mt-0.5 shrink-0 text-[var(--color-accent-500)]" />
                                        Pregled prihodkov in analitika
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="mx-auto max-w-2xl px-4 sm:px-6">
                ...
                <div class="mt-10 divide-y divide-neutral-100">
                    <div v-for="(item, index) in faqs" :key="item.q">
                        <button
                            type="button"
                            class="flex w-full items-center justify-between gap-4 rounded-lg px-3 py-5 text-left transition hover:bg-neutral-50"
                            @click="toggleFaq(index)"
                        >
                            <span class="text-[15px] font-medium text-neutral-900">{{ item.q }}</span>
                            <Plus v-if="openFaq !== index" :size="16" class="shrink-0 text-neutral-400" />
                            <Minus v-else :size="16" class="shrink-0 text-[var(--color-accent-500)]" />
                        </button>
                        <div
                        ...
                        >
                            <div class="overflow-hidden">
                                <p class="px-3 pb-5 text-sm leading-relaxed text-neutral-600">{{ item.a }}</p>
                            </div>
                        </div>
                    </div>
                </div>
